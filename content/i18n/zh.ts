...
export const zhUi: UiCopy = {
  ...
  identity: {
    tagline: "专注推荐系统、智能决策与数据产品的应用统计研究者",
    support:
      "将统计建模、深度学习与 AI Agent 应用于推荐排序、广告预测、智能投研和数据治理。",
    roleLine: "推荐系统 · 智能决策 · 数据产品",
    schools: [
      "厦门大学 · 应用统计（硕）",
      "四川大学 · 管理科学（本）",
    ],
  ...
  nav: [
    ...
    { href: "/work", label: "项目", index: "02" },
    { href: "/about", label: "关于", index: "03" },
    { href: "/contact", label: "联系", index: "04" },
  ],
  marquee: ["推荐系统", "智能决策", "数据治理", "统计建模"],
  loaderWords: [
    "你好",
    "Hello",
    "建模",
  ...
  meta: {
    title: "匡璇 · 作品集",
    description:
      "匡璇——专注推荐系统、智能决策与数据产品的应用统计研究者。厦门大学应用统计硕士 / 四川大学管理科学本科。",
  },
  socials: {},
}

export const zhProjects: LocalizedProject[] = [
  {
    slug: "taac-2026",
    title: "腾讯广告算法大赛",
    field: "广告排序",
...
export const zhAbout: LocalizedAbout = {
